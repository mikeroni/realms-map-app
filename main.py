...
def view_on_map(rail_paths):
    """Generate the map URL with the rail paths"""
    if not rail_paths:
        return None
    
    base_url = "https://public.tableau.com/app/profile/michael.manning4527/viz/MinecraftRealmsAioniaMapTest/AioniaWayfinder?Show%20Trains=1&"
    ...
    full_url = f"{base_url}Path={encoded_paths}"
